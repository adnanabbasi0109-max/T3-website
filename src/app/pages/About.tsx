  ...
  return (
    <div className="bg-t3-off-white">
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24 pt-16 md:pt-24 pb-24 md:pb-32">
        <div className="grid md:grid-cols-12 gap-12">
          <div className="md:col-span-8">
            ...
            <TextReveal
              text="We are not a consultancy. We are a catalyst process."
              delay={0.2}
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24 py-24 md:py-32">
        <div className="grid md:grid-cols-12 gap-12">
          <motion.div {...fadeInLeft} className="md:col-span-4">
            <h2 className="text-3xl md:text-4xl font-heading tracking-tight sticky top-24">
              Humane Technology
            </h2>
          </motion.div>
          <motion.div {...fadeInRight} className="md:col-span-8 space-y-6">
            <p className="text-xl md:text-2xl text-t3-muted-gray leading-relaxed">
            ...
            <motion.div
              ...
              className="pt-8"
            >
              <div className="inline-block px-6 py-3 border-2 border-t3-accent-gold rounded-lg hover:bg-t3-accent-gold/5 transition-colors duration-300">
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24 py-24 md:pb-32">
        ...
        >
          {[
            { num: '01', title: 'Deconstruct', desc: 'We break down complex challenges into fundamental components, identifying the leverage points others miss.' },
            { num: '02', title: 'Catalyze', desc: 'We create strategic interventions at the intersection of data, creativity, and human behavior.' },
            { num: '03', title: 'Transform', desc: 'We deliver solutions that create lasting competitive advantage and exponential impact.' }
          ].map(card => (
            <motion.div
              key={card.num}
